...
func (o *CreateVolumeRequest) GetComputeImage() string {
	if o == nil || IsNil(o.ComputeImage) {
		var ret string
		return ret
	}
	return *o.ComputeImage
}

// GetComputeImageOk returns a tuple with the ComputeImage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateVolumeRequest) GetComputeImageOk() (*string, bool) {
	if o == nil || IsNil(o.ComputeImage) {
		return nil, false
	}
	return o.ComputeImage, true
}
...
func (o CreateVolumeRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ComputeImage) {
		toSerialize["compute_image"] = o.ComputeImage
	}
